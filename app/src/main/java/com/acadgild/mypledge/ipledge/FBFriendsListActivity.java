...
import com.acadgild.mypledge.ipledge.adapter.FriendsAdapter;
...
public class FBFriendsListActivity extends AppCompatActivity
{
    ...
    private void getFBFriendsList() {
        ...
        GraphRequestAsyncTask r = GraphRequest.newGraphPathRequest(fbToken,"/me/taggable_friends", new Callback()
                {
